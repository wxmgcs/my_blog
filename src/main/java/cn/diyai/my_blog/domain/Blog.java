...
//	@OneToOne(cascade = CascadeType.DETACH, fetch = FetchType.LAZY)
    ...
    public Blog(String topic, String title, String content, String htmlContent) {
        this.tags = topic;
        this.title = title;
    ...
    public Blog(Long id, String title, String summary, String content, Timestamp createTime) {
        this.id = id;
        this.title = title;
